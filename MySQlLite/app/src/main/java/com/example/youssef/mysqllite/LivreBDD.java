...
public class LivreBDD {
    ...
    private SqlClasse maBaseSQLite;

    public LivreBDD(Context context){
        //On crée la BDD et sa table
        maBaseSQLite = new SqlClasse(context, NOM_BDD, null, VERSION_BDD);
    }
    ...
    public long insertLivre(Livre livre){
        ...
        values.put(COL_ISBN, livre.getIs());
    ...
    private Livre cursorToLivre(Cursor c){
        ...
        livre.setIs(c.getString(NUM_COL_ISBN));
